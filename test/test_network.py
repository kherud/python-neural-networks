...
class TestNeuralNetwork(unittest.TestCase):
    def setUp(self):
        ...
        self.nn1.layers[0].W = Tensor([3, 3], x=[-0.5057, 0.3987, -0.8943, 0.3356, 0.1673, 0.8321, -0.3485, -0.4597, -0.1121])
        self.nn1.layers[0].b = Tensor([3], x=[0., 0., 0.])
        self.nn1.layers[2].W = Tensor([3, 2], x=[0.4047, 0.9563, -0.8192, -0.1274, 0.3662, -0.7252])
