...
from nn.optimizer import MinibatchGradientDescent, Adam
...
for i in range(len(_y_train) // batch_size):
    index = batch_size * i
...
optimizer.optimize(neural_network, x_train, y_train, x_test, y_test, epochs=25, batch_size=batch_size)
